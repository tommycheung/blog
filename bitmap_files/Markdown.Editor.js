...
(function () {
    ...
    // entering links.
    var linkDialogText = "http://example.com/ \"optional title\"";
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            group1 = makeGroup(1);
            buttons.bold = makeButton("wmd-bold-button", "粗体 - Ctrl+B", "icon-bold", bindCommand("doBold"), group1);
            ...
            buttons.code = makeButton("wmd-code-button", "代码示例 - Ctrl+K", "icon-code", bindCommand("doCode"), group2);
